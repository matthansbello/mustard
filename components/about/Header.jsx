      ...
      <div className="container pt-80">
        <div className="ph-top">
          ...
          <span className="ph-crumb">
            Home <span className="sep">/</span> About
          </span>
        </div>
        <h1 className="text-u">
          Mustard<span className="grad-text">HQ</span>
        </h1>
        <div className="ph-meta">
          <div>
            <span className="k">Discipline</span>
            <span className="v">Design · Build · Brand · IT · Security</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span className="v">137+ Delivered</span>
          </div>
        </div>
      </div>
    </div>
