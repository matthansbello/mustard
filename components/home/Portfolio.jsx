...
function Portfolio() {
  const marquess = ['Projects Done']; // Replace with your actual array
            ...
            <div>
              ...
              <h3 className="fw-600 fz-50 text-u d-rotate wow">
                <span className="rotate-text">
                  Standout <span className="fw-200">Projects.</span>
                </span>
              </h3>
            </div>
        ...
        <div className="row">
          <div className="col-lg-2 d-flex align-items-end">
            <div className="text pb-100">
              <p>
              Discover the success of our client partnerships. Our portfolio demonstrates how we build collaborative solutions that drive growth.
              </p>
            </div>
          </div>
